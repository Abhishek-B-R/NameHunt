    ...
    <div className="relative min-h-[200vh] bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-[#05070A] dark:via-[#070A0F] dark:to-[#05070A]">
      ...
      <section className="w-full py-10">
        <div className="mx-auto max-w-5xl glass-card rounded-2xl p-6 text-center">
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Ready to compare prices?</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Find the best deal in under a minute.</p>
          <Button onClick={()=>searchRef?.current?.focus()} className="inline-flex items-center justify-center rounded-lg bg-teal-500 hover:bg-teal-600 dark:bg-teal-400 dark:hover:bg-teal-500 px-4 py-2 font-semibold text-white dark:text-black">
        Start a search
          </Button>
        </div>
      </section>
